...
function UploadModal({ onClose, uploadFile }) {
  ...
  return (
    <div
      ...
      onClick={(e) =>
        e.target === e.currentTarget && status !== "uploading" && onClose()
      }
    >
...
export default function ChatTab({
  ...
  const startDrag = useCallback(
    (e) => {
      ...
      function onMove(e) {
        setChatWidth(
          Math.min(680, Math.max(260, startW + (startX - e.clientX))),
        );
      }
      function onUp() {
        setDragging(false);
          ...
          <div className="split-dashboard">
            {hasCharts ? (
              ...
              <div className="split-no-charts">
                ...
                {!roomFile && (
                  <button
                    className="no-charts-upload-btn"
            ...
            >
              <div className="split-chat-header">
                ...
                <div className="split-chat-header-right">
                  ...
                  <button
                    className="split-chat-close-btn"
